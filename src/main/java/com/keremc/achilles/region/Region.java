...
public class Region implements Iterable<Location> {
    ...
    public Region(BasicDBObject dbo) {
        ...
        this.type = Tag.valueOf(dbo.getString("type"));
    }
    ...
    public Region expand(RegionDirection dir, int amount) {
        switch (dir) {
            case NORTH:
                return new Region(worldName, x1 - amount, y1, z1, x2, y2, z2);
            case SOUTH:
                return new Region(worldName, x1, y1, z1, x2 + amount, y2, z2);
            case EASY:
                return new Region(worldName, x1, y1, z1 - amount, x2, y2, z2);
            case WEST:
                return new Region(worldName, x1, y1, z1, x2, y2, z2 + amount);
            case DOWN:
                return new Region(worldName, x1, y1 - amount, z1, x2, y2, z2);
            case UP:
                return new Region(worldName, x1, y1, z1, x2, y2 + amount, z2);
            default:
    ...
    public Region getFace(RegionDirection dir) {
        switch (dir) {
            case DOWN:
                return new Region(worldName, x1, y1, z1, x2, y1, z2);
            case UP:
                return new Region(worldName, x1, y2, z1, x2, y2, z2);
            case NORTH:
                return new Region(worldName, x1, y1, z1, x1, y2, z2);
            case SOUTH:
                return new Region(worldName, x2, y1, z1, x2, y2, z2);
            case EASY:
                return new Region(worldName, x1, y1, z1, x2, y2, z1);
            case WEST:
                return new Region(worldName, x1, y1, z2, x2, y2, z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
